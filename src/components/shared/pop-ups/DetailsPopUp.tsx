  ...
  return (
    <SecondaryPopUp>
      <div className={style.btnCell}>
        ...
        <div className={style.caption}>הגשת בקשה</div>
      </div>
      ...
      <div className={style.btnCell}>
        ...
        <div className={style.caption}>מסמכים להורדה</div>
      </div>
      ...
      <div className={style.btnCell}>
        ...
        <div className={style.caption}>דשבורד</div>
      </div>
      ...
      <div className={style.btnCell}>
        ...
        <div className={style.caption}>הוספת שיבוץ</div>
      </div>
    </SecondaryPopUp>
  );
};
